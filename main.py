...
def print_banner():
    print(crayons.green('================================================ '))
    print(crayons.green('                AIRDROP ASC                      '))
    print(crayons.green('================================================  '))
    print(crayons.green('     Bot : Moonbix     '))
    ...
    def login(self):
        try:
            ...
            if response.status_code == 200:
                ...
                log("Login Sukses", level="SUCCESS")
                return True
            else:
    ...
    def complete_game(self):
        try:
            ...
            if response.json()['success']:
                log(f"Game Selesai... Saldo + {self.game['log']}", level="SUCCESS")
        ...
        try:
            while True:
                ...
                if self.game_response['code'] == '000000':
                    log("Memulai Game", level="INFO")
                    return True
                elif self.game_response['code'] == '116002':
                    log('Upaya tidak cukup! Beralih ke akun berikutnya', level="WARNING")
                    return False
...
def run_account(index, token, proxy=None):
    ...
    x.start()
    log(f" Account {index} Selesai ", level="SUCCESS")
    sleep(15)
...
if __name__ == '__main__':
    ...
    log("Semua Account Selesai", level="SUCCESS")
    sleep(2000)
